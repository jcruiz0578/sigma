	...
	<div class="gridContainer clearfix"
		...
		<div id="principal" class="fluid">
			...
			<div id="periodoescolar_mostrar" align="center">
				<h2>Período Escolar: <?php echo $periodoescolar?></h2>
			</div>

			<div id="escrito" align="right">
				<div id="logueo" style="font-weight: bold;">
					<font color="red">Logueado como:</font> <?php
					
echo $_SESSION ["session_user"];
					?>&nbsp;&nbsp;
		<a href='principal.php?logout'>Cerrar Sesion<?php session_name("session_user"); ?></a>
				</div>

				<div id="usuario" style="font-weight: bold;">
					<font color="red">Usuario:</font> <?php echo  $_SESSION["session_nombre"]; ?></div>
				<div id="categoria" style="font-weight: bold;">
					<font color="red">Categoria del Usuario:</font> <?php echo $_SESSION["session_categoria"]; ?></div>
		...
		?>
			...
			<div id="separacion0" style="width: auto; height: 80px"></div>

			<div id="datos" class="container-fluid" align="center"
				style="width: auto;">
				...
				<form action="" method="POST">
					...
					<select id="anno_estudio" name="anno_estudio"
					...
					</select> <select id="seccion" name="seccion"
						class="btn dropdown-toggle"
						style="width: auto; height: auto; font-size: 16px">
					...
					</select> <select name="combomaterias" id="combomaterias"
						class="btn dropdown-toggle" style="width: auto;">


					</select> <select name="combolapso" id="combolapso"
						class="btn dropdown-toggle" style="width: auto;">
					...
					<!-- se crea unos imput ocultos para poder envir los valores de la primera recarga   -->


					<button id="enviar" type="submit" name="submit"
						class="btn btn-primary dropdown-toggle"
						style="font-size: 16px; height: 40px">Consultar</button>
				</form>
			...
			<div id="contenidos" class="container-fluid" align="center"
				style="width: auto;">

				<form action="notas_proceso.php" method="POST">
...
$combomaterias = $_POST ['combomaterias'];

?>


<input type="text" name="combolapsoE" id="combolapsoE" value="<?php echo $lapso ; ?>" />
 <input type="text" name="anno_estudioE" id="anno_estudioE" value="<?php echo $anno_estudio ; ?>"> 
 <input type="text" name="seccionE" id="seccionE" value="<?php echo $seccion ; ?>"> 
 <input type="text" name="combomateriasE" id="combomateriasE" value="<?php echo $combomaterias  ; ?>">
					...
					<table class="table table-hover table-striped" id="tabla"
						...
						<thead>
							<tr bgcolor="#0099CC">
								...
								<th style="text-align: center">CEDULA ID</th>
								<th style="text-align: center; width: auto">NOMBRE y APELLIDOS</th>
    ...
    <tr id="fila<?php echo trim($user['id_ingreso']) ?>">
								<td align="center"><input type="text" name="contador[]"
									id="contador[]" style="width: 30px; text-align: center"
									value="<?php echo $contador ?>"></td>
								<td align="center"><input type="text" name="id_ingreso[]"
									id="id_ingreso[]"
									value="<?php echo trim($user['id_ingreso'])?>"></td>
								<td align="center"><input type="text" name="cedula[]"
									id="cedula[]"
									style="text-align: center; width: auto; font-weight: bold"
									value="<?php echo trim($user['cedulaest']) ?>"></td>
								<td align="center"><input type="text" name="nombres[]"
									id="nombres[]" style="width: 350px; font-weight: bold"
									value="<?php echo $nombre ?>"></td>
								<td align="center"><input type="number" name="notas[]"
									id="notas[]" style="width: 60px; text-align: center" max="20"
									TABINDEX="<?php echo $contador ?>" autofocus></td>
