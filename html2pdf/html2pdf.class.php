...
class HTML2PDF {
	 ...
	 *        	name of the default font to use. If null : Arial if no font is specified, and error if the asked font does not exist
	 * @return HTML2PDF $this
	 */
	...
	/**
	 * init a sub HTML2PDF.
	 * do not use it directly. Only the method createSubHTML must use it
	 *
	 * @access public
	 * @param string $format        	
	 * @param string $orientation        	
...
<html>
	 ...
	 * @param integer $curr
	 *        	real position in the html parser (if break line in the write of a text)
	 ...
	 * @param array $border        	
	 * @param float $padding
	 *        	- internal margin of the rectangle => not used, but...
	 * @param float $margin
	 *        	- external margin of the rectangle
	 * @param array $background        	
	 * @return boolean
	 * @throws HTML2PDF_exception
	 */
	...
	/**
	 * new page for the automatic Index, do not use this method.
