...
$pdf->Bookmark ( 'Chapter 2', 0, 0, '', 'BI', array (
		128,
		0,
		0 
), - 1, '#chapter2' );
...
$pdf->SetFont ( 'times', 'B', 20 );
$pdf->Bookmark ( 'Chapter 3', 0, 0, '', 'B', array (
		0,
		64,
		128 
) );
...
$pdf->SetFont ( 'times', 'B', 20 );
$pdf->Bookmark ( 'Chapter 4', 0, 0, '', 'B', array (
		0,
		64,
		128 
) );
...
$pdf->AddPage ();
$pdf->Bookmark ( 'Chapter 5', 0, 0, '', 'B', array (
		0,
		128,
		0 
) );
...
$pdf->Annotation ( 20, 50, 5, 5, 'TXT file', array (
...
$pdf->Bookmark ( 'TXT file', 0, 0, '', 'B', array (
		128,
		0,
		255 
), - 1, '*utf8test.txt' );
...
// add a bookmark that points to an embedded file
// NOTE: prefix the file name with the * character for generic file and with % character for PDF file
$pdf->Bookmark ( 'PDF file', 0, 0, '', 'B', array (
		128,
		0,
		255 
), - 1, '%example_012.pdf' );
...
$pdf->Bookmark ( 'External URL', 0, 0, '', 'B', array (
		0,
		0,
		255 
