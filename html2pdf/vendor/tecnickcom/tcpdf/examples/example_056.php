...
$pdf->cropMark ( 95, 65, 5, 5, 'LEFT,TOP,RIGHT', array (
		255,
		0,
		0 
) );
$pdf->cropMark ( 95, 125, 5, 5, 'LEFT,BOTTOM,RIGHT', array (
		255,
		0,
		0 
) );

$pdf->cropMark ( 45, 95, 5, 5, 'TL,BL', array (
		0,
		255,
		0 
) );
$pdf->cropMark ( 145, 95, 5, 5, 'TR,BR', array (
		0,
		255,
		0 
) );

$pdf->cropMark ( 95, 140, 5, 5, 'A,D', array (
		0,
		0,
		255 
) );
...
$pdf->registrationMark ( 150, 60, 5, true, array (
		0,
		0,
		0 
), array (
...
$pdf->registrationMark ( 40, 130, 5, true, array (
		0,
		0,
		0 
), array (
...
$pdf->registrationMark ( 150, 130, 5, false, array (
		100,
		100,
		100,
		100,
