...
$registros_vigente = "SELECT * FROM ingresos, estudiantes, representantes where estudiantes.cedulaest=ingresos.cedulaest and anoest like '$Comboanoest'  and periodoescolar='$periodoescolar' and representantes.cedularep = ingresos.cedularep order by  ingresos.ficha asc "; // sentencia sql
...
while ($user = $result_vigente->fetch_array()) {
    ...
    <tr id="fila-<?php echo trim($user['id_ingreso']) ?>">
        ...
        <td style="text-align: center" ><FONT COLOR=<?php echo $color_E ?>><?php echo trim($user['repitienteest']) ?></FONT></td>
        <td style="text-align: center" ><FONT COLOR=<?php echo $color_E ?>><?php echo trim($user['rezagado']) ?></FONT></td>
        <td style="text-align: center" ><FONT COLOR=<?php echo $color_E ?>><?php echo trim($user['ficha']) ?></FONT></td>
