...
$consulta = "SELECT *  FROM estudiantes, ingresos WHERE ingresos.cedulaest = '$cedula' and estudiantes.cedulaest=ingresos.cedulaest and periodoescolar = '$periodoescolar' limit 1 ";
...
$respuesta->id_ingreso = $fila [id_ingreso];
	...
	$respuesta->num_reg = $fila [num_reg];
}
